...
<div class="paginas-internas">
    ...
    <main class="p-1">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h1 style="color:#c8ccd0;"><b>Formulario de contacto</b></h1> {!! Form::open(['route' => 'enviarContacto', 'method' => 'POST']) !!}
                    ...
                    <div class="col-md-10 offset-md-1">
                        <div class="buttons">
                            {!! Form::submit('Enviar', ['class' => 'btn blue']) !!} {!! Form::reset('Limpiar', ['class' => 'btn purple', 'id' => 'reset']) !!}
                        </div>
                    </div>
                    {!! Form::close() !!}
                </div>
