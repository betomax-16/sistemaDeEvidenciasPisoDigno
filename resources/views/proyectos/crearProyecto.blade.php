...
<div class="container espacioPagina marco">
    <div class="row">
        <div class="col-md-12">
          ...
          <hr>
          {!! Form::open(['route' => 'proyecto.store', 'method' => 'POST', 'id' => 'form-add']) !!}
...
@endsection
@section('javascripts')
<script type="text/javascript" src="{{asset('js/Proyectos/addProyecto.js')}}"></script>
<script type="text/javascript">
  var token = '{{ Session::token() }}';
  var redirect = '{{route("proyectosPorPrograma",Session::get("programa"))}}';
</script>
<script type="text/javascript">
