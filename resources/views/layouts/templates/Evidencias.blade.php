  ...
  <button class="fotos col-xs-12 col-md-3 text-xs-center " href="#FamiliaF" data-toggle="modal" data-target="#FamiliaF">
      @foreach($beneficiado->fotos as $foto)
        <div class="secundaria col-md-6">
            ...
            <img src="{{asset('imagenes/evidencias').'/'.$foto->nombreArchivo}}" class="img-fluid  hidden-md-down" alt="">
            @endif
        </div>
        <div class="secundaria col-md-6">
        ...
        <div class="principal " title='Agrega aquí el pie de foto'>
            ...
            <img src="{{asset('imagenes/evidencias').'/'.$foto->nombreArchivo}}" class="img-fluid " alt="">
            @endif
        </div>
      @endforeach
  </button>
